...
select 
a.plan_name,
a.quality_performance as L5_quality_performance,
b.quality_performance as L3_quality_performance
from
(
select 
p.plan_name,
...
a.visit_percent,
b.visit_percent
from L5_visit_percent a
join L3_visit_percent b on 
a.visit_percent = b.visit_percent
order by 1;
-- AWV Score %
...
select 
a.plan_name,
a.awv_goal as L5_awv_goal,
b.awv_goal as L3_awv_goal
from l5_awv_goal a
join L3_awv_goal b on 
a.plan_name = b.plan_name;