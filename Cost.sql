...
select 
a.plan_name,
a.recapture_rate as L5_recapture_rate,
b.recapture_rate as L3_recapture_rate
from
(
select 
p.plan_name,
...
select 
a.plan_name,
a.average_documented_risk  L5_average_documented_risk,
b.average_documented_risk  L3_average_documented_risk
from
(
select 
p.plan_name,
...
select 
a.plan_name,
a.average_potential_risk as L5_average_potential_risk,
b.average_potential_risk as L3_average_potential_risk
from
(
select 
p.plan_name,
